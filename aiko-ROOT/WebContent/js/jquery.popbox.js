...
(function($){
	$.popbox = function(opts){
		...
		var box = {
			template : '<div class="pb_container"><div class="pb_mask"></div><div class="pb_panel"><div class="pb_header"><h2 class="pb_title"></h2><a href="javascript:void(0);" class="pb_closebtn">X</a></div><div class="pb_body"></div><div class="pb_btns"></div><div class="pb_footer"></div></div></div>',
			init : function(template){
				...
				//template.find('.pb_panel').css({height : option.maxHeight});
