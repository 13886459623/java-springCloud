...
var demo_themes = [
  { name: 'default', title: 'Default', img: '/js/pixeladmin/demo/themes/default.png' },
  { name: 'asphalt', title: 'Asphalt', img: '/js/pixeladmin/demo/themes/asphalt.png' },
  { name: 'purple-hills', title: 'Purple Hills', img: '/js/pixeladmin/demo/themes/purple-hills.png' },
  { name: 'adminflare',  title: 'Adminflare', img: '/js/pixeladmin/demo/themes/adminflare.png' },
  { name: 'dust',  title: 'Dust', img: '/js/pixeladmin/demo/themes/dust.png' },
  { name: 'frost',  title: 'Frost', img: '/js/pixeladmin/demo/themes/frost.png' },
  { name: 'fresh',  title: 'Fresh', img: '/js/pixeladmin/demo/themes/fresh.png' },
  { name: 'silver',  title: 'Silver', img: '/js/pixeladmin/demo/themes/silver.png' },
  { name: 'clean',  title: 'Clean', img: '/js/pixeladmin/demo/themes/clean.png' },
  { name: 'white',  title: 'White', img: '/js/pixeladmin/demo/themes/white.png' }
];
