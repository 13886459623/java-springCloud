...
<link rel="stylesheet" type="text/css" href="manage/Styles/base.css" />
<link rel="stylesheet" type="text/css"
	href="manage/Styles/admin-all.css" />
<link rel="stylesheet" type="text/css"
	href="manage/Styles/bootstrap.min.css" />
<script type="text/javascript" src="manage/Scripts/jquery-1.7.2.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/pc/report/jquery.blockUI.js"></script>
<script type="text/javascript"
	src="manage/Scripts/jquery.spritely-0.6.js"></script>
<script type="text/javascript" src="manage/Scripts/chur.min.js"></script>
<link rel="stylesheet" type="text/css" href="manage/Styles/login.css" />
