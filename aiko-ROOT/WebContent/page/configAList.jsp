...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/file-input/fileinput.css">
...
<script src="${pageContext.request.contextPath }/js/file-input/fileinput.js"></script>
<%--<script src="${pageContext.request.contextPath }/js/file-input/fileinput_locale_zh.js"></script>--%>
...
function TableInti(){
	...
	var TGM = table.GM({
		...
		,supportSorting: true
		,ajax_url: '${pageContext.request.contextPath }/configA/configAList'
		,ajax_type: 'POST'
		,query: {}   //参数
		,pageSize:20
...
*/
function submitForm() {
	var url="${pageContext.request.contextPath }/configA/updateCondigA";
 	$.ajax({
		  type:'post',
		  url:url,
...
function restart() {
	var url="${pageContext.request.contextPath }/configA/restartA";
	$.ajax({
		type:'post',
		url:url,
		data:'',
		...
		<form id="fm"  method="post" action="" enctype="multipart/form-data">
			<table id="tableShow">
			  <tr>
				...
				<td><input id="remark" name="remark" type="text" value="" size="30" maxlength="200" /></td>
			  ...
			  <tr>
				...
				<td colspan="3"><textarea id="parameters" name="parameters" style="width: 100%"></textarea></td>
			  </tr>
