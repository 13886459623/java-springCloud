...
function getProduct() {
	var url="${pageContext.request.contextPath }/configB/getConfigBproduct";
	$.ajax({
		type:'post',
		url:url,
		data:"",
...
function submitData() {
	var url="${pageContext.request.contextPath }/configB/updateBProductSwitch";
...
<body >
<p style="font-size: 15px;">当前位置：参数配置>产品切换>B线产品切换 </p>
<!-- 导航栏 -->
	...
	<div class="search-area">
		...
		<div class="sa-ele">
		  可切换产品:
			<select  id="productAB">
				<option selected="selected" value="config_4bb_b">4BB</option>
				<option value="config_5bb_b">5BB</option>
			</select>
		</div>
		<div class="sa-ele">
