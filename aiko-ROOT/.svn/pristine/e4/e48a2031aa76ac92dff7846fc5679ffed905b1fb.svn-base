...
},beforePageText:"第",afterPageText:"页/共 {pages}页",displayMsg:"第{from}-{to}条/共{total}条",nav:{first:{iconCls:"pagination-first",handler:function(){
...
$.fn.validatebox.defaults={required:false,validType:null,delay:200,missingMessage:"此项为必填项",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,tipOptions:{showEvent:"none",hideEvent:"none",showDelay:0,hideDelay:0,zIndex:"",onShow:function(){
...
},message:"请输入正确的邮箱地址"},url:{validator:function(_42b){
...
},message:"请输入正确的URL地址"},length:{validator:function(_42c,_42d){
