...
var logshow="";
	...
	function getdata(){
		var url="${pageContext.request.contextPath}/rest/showImageA";
		 $.ajax({ 
				  type:'post', 
				  url:url,
				  data:{},
...
<!-- 导航栏 -->
<div class="in-top">
 <p style="color: white;font-size: 15px;width: 60%;height: 5%">当前位置：前端页面>AB产线>A线页面 </p>
 <p style="color: white;width: 40%;margin-left: 30%;height: 8%;font-size: 25px;">A线算法运行状态:  
