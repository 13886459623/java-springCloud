...
function initTreeMenu(isInit,tree){
    var url;
    var title;
    var target;
    var tabTitle;
    ...
    var iconfont;
    if(isInit){
    	url='/aiko-ROOT/page/showImageA.jsp';
    	title='前端页面';
    	target='';
    	appcode='sort';
    	iconfont='&#xe62a;';
    	...
    	target=tree.data('target');
    	appcode=tree.data('appcode');
    	iconfont=tree.data('iconfont');
    }
